  ...
  <div>
      ...
      <form @submit.prevent="onSubmit">
        ...
        <div class="mb-3">
          ...
          <input type="tel" class="form-control" id="phone-input" required="" placeholder="000-000-0000" v-model="phoneNumber">
        </div>
        <div class="mb-3">
...
export default {
  ...
  methods:{
    onSubmit(){
      ...
      // console.log("form submitted", myFormData);
      axios.post("/guests",myFormData)
      .then((myResponse)=>{
